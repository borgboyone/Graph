    ...
    function assert_throws(code, func, description)
    {
        ...
        catch(e)
        {
            ...
            if (typeof code === "object")
            {
                ...
                if ('message' in code) {
                    assert(typeof e == 'object' && "message" in e && e.message == code.message,
                        "assert_throws", description,
                        "${func} threw ${actual} (${actual_message}) expected ${expected} (${expected_message})",
                                    {func:func, actual:e, actual_message:e.message,
                                     expected:code,
                                     expected_message:code.message});
                }
                return;
            }
